                        ...
                        <tr>
                            ...
                            <td>
                                <div class="avatar-group">
                                    ...
                                    <span id="<?php echo 'demo_' . $i ?>" class="User"><?php echo count($form) ?>/<?php echo count($assessor) ?></span>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="progress">
                                            <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo '60%' ?>;"></div>
                                        </div>
                                    </div>
                                </div>
                            </td>
